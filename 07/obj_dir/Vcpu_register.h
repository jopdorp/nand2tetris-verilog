...
#ifndef _Vcpu_register_H_
#define _Vcpu_register_H_
...
VL_MODULE(Vcpu_register) {
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vcpu_register);  ///< Copying not allowed
  public:
    Vcpu_register(const char* name="TOP");
    ~Vcpu_register();
