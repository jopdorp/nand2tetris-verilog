...
#include "Vcpu_register.h"     // For This
...
VL_CTOR_IMP(Vcpu_register) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vcpu_register::__Vconfigure(Vcpu__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vcpu_register::~Vcpu_register() {
}

//--------------------
// Internal Methods

void Vcpu_register::_initial__TOP__cpu__DOT__a_register__3(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_initial__TOP__cpu__DOT__a_register__3\n"); );
...
VL_INLINE_OPT void Vcpu_register::_sequent__TOP__cpu__DOT__a_register__6(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_sequent__TOP__cpu__DOT__a_register__6\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at dff.sv:2
...
void Vcpu_register::_settle__TOP__cpu__DOT__a_register__9(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_settle__TOP__cpu__DOT__a_register__9\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vcpu_register::_combo__TOP__cpu__DOT__a_register__11(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_combo__TOP__cpu__DOT__a_register__11\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->__PVT__genblk1__BRA__0__KET____DOT__bit_n2t__DOT__mux_load__DOT__not_sel_not_a__DOT__nand_a_b 
	= (1U & (~ ((~ (IData)(vlTOPp->cpu__DOT__should_load_a_register)) 
...
VL_INLINE_OPT void Vcpu_register::_sequent__TOP__cpu__DOT__d_register__5(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_sequent__TOP__cpu__DOT__d_register__5\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at dff.sv:2
    this->genblk1__BRA__0__KET____DOT____Vcellout__bit_n2t____pinNumber4 
...
void Vcpu_register::_settle__TOP__cpu__DOT__d_register__8(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_settle__TOP__cpu__DOT__d_register__8\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->__PVT__genblk1__BRA__0__KET____DOT__bit_n2t__DOT__mux_load__DOT__not_sel_not_a__DOT__nand_a_b 
	= (1U & (~ ((IData)(vlTOPp->cpu__DOT__c_instruction_and_dest_d__DOT__nand_a_b) 
...
VL_INLINE_OPT void Vcpu_register::_combo__TOP__cpu__DOT__d_register__10(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_combo__TOP__cpu__DOT__d_register__10\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->__PVT__genblk1__BRA__0__KET____DOT__bit_n2t__DOT__mux_load__DOT__not_sel_not_a__DOT__nand_a_b 
	= (1U & (~ ((IData)(vlTOPp->cpu__DOT__c_instruction_and_dest_d__DOT__nand_a_b) 
...
VL_INLINE_OPT void Vcpu_register::_sequent__TOP__cpu__DOT__program_counter__DOT__count__4(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_sequent__TOP__cpu__DOT__program_counter__DOT__count__4\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at dff.sv:2
    this->genblk1__BRA__0__KET____DOT____Vcellout__bit_n2t____pinNumber4 
...
void Vcpu_register::_settle__TOP__cpu__DOT__program_counter__DOT__count__7(Vcpu__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_settle__TOP__cpu__DOT__program_counter__DOT__count__7\n"); );
    Vcpu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->out = ((0xfffeU & (IData)(this->out)) | (IData)(this->genblk1__BRA__0__KET____DOT____Vcellout__bit_n2t____pinNumber4));
    this->out = ((0xfffdU & (IData)(this->out)) | ((IData)(this->genblk1__BRA__1__KET____DOT____Vcellout__bit_n2t____pinNumber4) 
...
void Vcpu_register::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcpu_register::_ctor_var_reset\n"); );
    // Body
